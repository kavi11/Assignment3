...
namespace CSV.Models
{
    public class FTP
    {
        public static List<string> GetDirectory(string url, string username = Constants.Location.FTP.Username, string password = Constants.Location.FTP.Password)
        {
        ...
        /// <returns></returns>
        public static bool FileExists(string remoteFileUrl, string username = Constants.Location.FTP.Username, string password = Constants.Location.FTP.Password)
        {
        ...
        public static byte[] DownloadFileBytes(string sourceFileUrl, string username = Constants.Location.FTP.Username, string password = Constants.Location.FTP.Password)
        {
            byte[] output;
